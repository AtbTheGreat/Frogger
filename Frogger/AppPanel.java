...
public class AppPanel extends JPanel implements Runnable,KeyListener,ActionListener
{
  ...
  private void createAquatics()
  {
    ...
    for(int i=0; i<(logDistance-frogBounds.width/2); i++)
    {
      WaterGap waterGap0=new WaterGap(waterBounds.x+i, waterBounds.y+objectHeight+1, 1);
      waterGap0.setDirection(1, 0);
      logs0WaterGaps.add(waterGap0);
      WaterGap waterGap1=new WaterGap(waterBounds.x+waterBounds.width-(logDistance-frogBounds.width/2)+i, waterBounds.y+objectHeight+1, 1);
      waterGap1.setDirection(1, 0);
      logs0WaterGaps.add(waterGap1);
      WaterGap waterGap2=new WaterGap(waterBounds.x+i, waterBounds.y+3*(objectHeight+1), 1);
      waterGap2.setDirection(1, 0);
      logs1WaterGaps.add(waterGap2);
      WaterGap waterGap3=new WaterGap(waterBounds.x+waterBounds.width-(logDistance-frogBounds.width/2)+i, waterBounds.y+3*(objectHeight+1), 1);
      waterGap3.setDirection(1, 0);
      logs1WaterGaps.add(waterGap3);
    }
    for(int i=0; i<(logDistance-frogBounds.width); i++)
    {
      WaterGap waterGap0=new WaterGap(waterBounds.x+logDistance+logWidth+frogBounds.width/2+i, waterBounds.y+objectHeight+1, 1);
      waterGap0.setDirection(1, 0);
      logs0WaterGaps.add(waterGap0);
      WaterGap waterGap1=new WaterGap(waterBounds.x+logDistance+logWidth+frogBounds.width/2+i, waterBounds.y+3*(objectHeight+1), 1);
      waterGap1.setDirection(1, 0);
      logs0WaterGaps.add(waterGap1);
    }
    ...
    for(int i=0; i<(turtleDistance-frogBounds.width); i++)
    {
      WaterGap waterGap0=new WaterGap(waterBounds.x+waterBounds.width-turtleWidth-frogBounds.width/2-i, waterBounds.y+2*(objectHeight+1), 1);
      waterGap0.setDirection(-1, 0);
      turtlesWaterGaps.add(waterGap0);
      WaterGap waterGap1=new WaterGap(waterBounds.x+waterBounds.width-(2*turtleWidth+turtleDistance+frogBounds.width/2)-i, waterBounds.y+2*(objectHeight+1), 1);
      waterGap1.setDirection(-1, 0);
      turtlesWaterGaps.add(waterGap1);
    }
  }
